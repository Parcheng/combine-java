...
@Component(key = "execute", name = "组件执行组件", logicConfigClass = LogicExecuteLogicConfig.class, initConfigClass = IInvalidInitConfig.class)
@ComponentResult(name = "组件执行结果")
public class LogicExecuteComponent extends AbstractComponent<IInvalidInitConfig, LogicExecuteLogicConfig> {

    public LogicExecuteComponent() {
        super(IInvalidInitConfig.class, LogicExecuteLogicConfig.class);
    }
