...
@Component(order = 100, key = "convert.text-table", name = "文本转为表格组件", logicConfigClass = DataTextToTableLogicConfig.class, initConfigClass = IInvalidInitConfig.class)
@ComponentResult(name = "表格格式的数据（二维数组的矩阵）")
public class DataTextToTableComponent extends AbstractComponent<IInvalidInitConfig, DataTextToTableLogicConfig> {

    public DataTextToTableComponent() {
        super(IInvalidInitConfig.class, DataTextToTableLogicConfig.class);
    }
