...
@Component(order = 400, key = "output.download", name = "文件数据下载组件", logicConfigClass = FileOutputDownloadLogicConfig.class, initConfigClass = IInvalidInitConfig.class)
@ComponentResult(name = "文件数据", isDownload = true)
public class FileOutputDownloadComponent extends FileOutputComponent<IInvalidInitConfig, FileOutputDownloadLogicConfig> {

    public FileOutputDownloadComponent() {
        super(IInvalidInitConfig.class, FileOutputDownloadLogicConfig.class);
    }
