...
@Component(key = "doc.components", name = "获取组件API", logicConfigClass = SystemDocSettingsLogicConfig.class, initConfigClass = IInvalidInitConfig.class)
@ComponentResult(name = "所有组件设API集合")
public class SystemDocSettingsComponent extends AbstractComponent<IInvalidInitConfig, SystemDocSettingsLogicConfig> {

    public SystemDocSettingsComponent() {
        super(IInvalidInitConfig.class, SystemDocSettingsLogicConfig.class);
    }
