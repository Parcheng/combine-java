...
@Component(order = 2, key = "text.regex", name = "文本正则处理组件", logicConfigClass = DataTextRegexLogicConfig.class, initConfigClass = IInvalidInitConfig.class)
@ComponentResult(name = "处理后的文本（集合）")
public class DataTextRegexComponent extends AbstractComponent<IInvalidInitConfig, DataTextRegexLogicConfig> {

    public DataTextRegexComponent() {
        super(IInvalidInitConfig.class, DataTextRegexLogicConfig.class);
    }
