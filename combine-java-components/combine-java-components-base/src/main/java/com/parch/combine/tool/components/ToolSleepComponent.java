...
@Component(key = "sleep", name = "休眠组件", logicConfigClass = ToolSleepLogicConfig.class, initConfigClass = IInvalidInitConfig.class)
@ComponentResult(name = "true 或报错")
public class ToolSleepComponent extends AbstractComponent<IInvalidInitConfig, ToolSleepLogicConfig> {

    public ToolSleepComponent() {
        super(IInvalidInitConfig.class, ToolSleepLogicConfig.class);
    }
