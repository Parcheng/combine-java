...
@Component(key = "error", name = "错误抛出组件", logicConfigClass = LogicErrorLogicConfig.class, initConfigClass = IInvalidInitConfig.class)
@ComponentResult(name = "配置的错误信息或 true")
public class LogicErrorComponent extends AbstractComponent<IInvalidInitConfig, LogicErrorLogicConfig> {

    public LogicErrorComponent() {
        super(IInvalidInitConfig.class, LogicErrorLogicConfig.class);
    }
