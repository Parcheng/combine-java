...
import com.parch.combine.html.old.base.element.InputElementLogicConfig;
...
public class InputElementComponent extends AbstractElementComponent<InputElementLogicConfig> {

    /**
     * 构造器
     */
    public InputElementComponent() {
