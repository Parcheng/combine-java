...
import com.parch.combine.html.old.base.element.TextareaElementLogicConfig;
...
public class TextareaElementComponent extends AbstractElementComponent<TextareaElementLogicConfig> {

    /**
     * 构造器
     */
    public TextareaElementComponent() {
