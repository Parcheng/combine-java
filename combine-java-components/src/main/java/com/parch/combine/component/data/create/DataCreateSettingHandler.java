 ...
 * 设置处理器
 */
public class DataCreateSettingHandler {
    ...
    public static ComponentSetting get() {
        ComponentSettingBuilder builder = new ComponentSettingBuilder("create", "数据创建组件", false, DataCreateComponent.class);
        // builder.addDesc("数据创建");
