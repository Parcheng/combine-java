...
public class GUITreeElement extends AbstractGUIComponentElement<GUITreeElementTemplate, GUITreeElement.Config, GUITreeElement.ConfigValue> {
    ...
    public GUITreeElement(String scopeKey, String domain, String elementId, Map<String, Object> data, GUITreeElementTemplate template, Config config) {
        super(scopeKey, domain, elementId, data, "paging", template, config, GUITreeElementTemplate.class);
    }
