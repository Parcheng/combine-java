...
public abstract class AbstractGUIComponentElement<T, C extends GUIElementConfig<V>, V> extends AbstractGUIElement<T, C, V> {
    ...
    public AbstractGUIComponentElement(String scopeKey, String domain, String id, Map<String, Object> data, String type, T template, C config, Class<T> templateClass) {
