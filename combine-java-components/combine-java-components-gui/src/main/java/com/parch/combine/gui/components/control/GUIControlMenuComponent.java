...
import com.parch.combine.gui.base.control.menu.GUIControlMenuInitConfig;
import com.parch.combine.gui.base.control.menu.GUIControlMenuLogicConfig;
import com.parch.combine.gui.base.control.menu.GUIMenuElement;
import com.parch.combine.gui.core.element.IGUIElement;

@Component(key = "control.menu", name = "GUI菜单模块", logicConfigClass = GUIControlMenuLogicConfig.class, initConfigClass = GUIControlMenuInitConfig.class)
