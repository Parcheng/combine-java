...
import com.parch.combine.html.base.template.TagElementTemplateLogicConfig;
...
@PageElement(key = "tag", name = "标签元素", templateClass = TagElementTemplateLogicConfig.class)
public class TagElementConfig extends ElementConfig<TagElementTemplateLogicConfig> {
    ...
    public TagElementConfig() {
        super(SystemElementPathTool.buildJsPath("tag"), SystemElementPathTool.buildCssPath("tag"),
                SystemElementPathTool.buildTemplatePath("tag"), TagElementTemplateLogicConfig.class);
    }
