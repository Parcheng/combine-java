...
@PageElement(key = "from", name = "表单元素", templateClass = FromElementTemplateLogicConfig.class)
public class FromElementConfig extends ElementConfig<FromElementTemplateLogicConfig> {
    ...
    public FromElementConfig() {
        super(SystemElementPathTool.buildJsPath("from"), SystemElementPathTool.buildCssPath("from"),
                SystemElementPathTool.buildTemplatePath("from"), FromElementTemplateLogicConfig.class);
    }
