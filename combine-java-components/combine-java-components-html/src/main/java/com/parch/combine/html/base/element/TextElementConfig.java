...
import com.parch.combine.html.base.template.TextElementTemplateLogicConfig;
...
@PageElement(key = "text", name = "复杂文本元素", templateClass = TextElementTemplateLogicConfig.class)
public class TextElementConfig extends ElementConfig<TextElementTemplateLogicConfig> {
    ...
    public TextElementConfig() {
        super(SystemElementPathTool.buildJsPath("text"), SystemElementPathTool.buildCssPath("text"),
                SystemElementPathTool.buildTemplatePath("text"), TextElementTemplateLogicConfig.class);
    }
