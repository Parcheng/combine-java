...
import com.parch.combine.html.old.base.element.PopElementLogicConfig;
...
public class PopElementComponent extends AbstractElementComponent<PopElementLogicConfig> {

    /**
     * 构造器
     */
    public PopElementComponent() {
