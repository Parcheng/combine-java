...
@PageElement(key = "pop", name = "泡泡窗元素", templateClass = PopElementTemplateLogicConfig.class)
public class PopElementConfig extends ElementConfig<PopElementTemplateLogicConfig> {
    ...
    public PopElementConfig() {
        super(SystemElementPathTool.buildJsPath("pop"), SystemElementPathTool.buildCssPath("pop"),
                SystemElementPathTool.buildTemplatePath("pop"), PopElementTemplateLogicConfig.class);
    }
