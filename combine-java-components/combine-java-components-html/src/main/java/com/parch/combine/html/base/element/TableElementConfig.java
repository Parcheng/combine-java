...
@PageElement(key = "table", name = "表格元素", templateClass = TableElementTemplateLogicConfig.class)
public class TableElementConfig extends ElementConfig<TableElementTemplateLogicConfig> {
    ...
    public TableElementConfig() {
        super(SystemElementPathTool.buildJsPath("table"), SystemElementPathTool.buildCssPath("table"),
                SystemElementPathTool.buildTemplatePath("table"), TableElementTemplateLogicConfig.class);
    }
