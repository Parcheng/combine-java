...
@PageElement(key = "window", name = "弹窗元素", templateClass = WindowElementTemplateLogicConfig.class)
public class WindowElementConfig extends ElementConfig<WindowElementTemplateLogicConfig> {
    ...
    public WindowElementConfig() {
        super(SystemElementPathTool.buildJsPath("window"), SystemElementPathTool.buildCssPath("window"),
                SystemElementPathTool.buildTemplatePath("window"), WindowElementTemplateLogicConfig.class);
    }
