...
@PageElement(key = "radio", name = "单选框元素", templateClass = RadioElementTemplateLogicConfig.class)
public class RadioElementConfig extends ElementConfig<RadioElementTemplateLogicConfig> {
    ...
    public RadioElementConfig() {
        super(SystemElementPathTool.buildJsPath("radio"), SystemElementPathTool.buildCssPath("radio"),
                SystemElementPathTool.buildTemplatePath("radio"), RadioElementTemplateLogicConfig.class);
    }
