...
@PageElement(key = "tree", name = "树元素", templateClass = TreeElementTemplateLogicConfig.class)
public class TreeElementConfig extends ElementConfig<TreeElementTemplateLogicConfig> {
    ...
    public TreeElementConfig() {
        super(SystemElementPathTool.buildJsPath("tree"), SystemElementPathTool.buildCssPath("tree"),
                SystemElementPathTool.buildTemplatePath("tree"), TreeElementTemplateLogicConfig.class);
    }
