...
@PageElement(key = "tab", name = "页签元素", templateClass = TabElementTemplateLogicConfig.class)
public class TabElementConfig extends ElementConfig<TabElementTemplateLogicConfig> {
    ...
    public TabElementConfig() {
        super(SystemElementPathTool.buildJsPath("tab"), SystemElementPathTool.buildCssPath("tab"),
                SystemElementPathTool.buildTemplatePath("tab"), TabElementTemplateLogicConfig.class);
    }
