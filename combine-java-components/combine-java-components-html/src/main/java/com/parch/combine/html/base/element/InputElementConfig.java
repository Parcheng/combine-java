...
@PageElement(key = "input", name = "输入框元素", templateClass = InputElementTemplateLogicConfig.class)
public class InputElementConfig extends ElementConfig<InputElementTemplateLogicConfig> {
    ...
    public InputElementConfig() {
        super(SystemElementPathTool.buildJsPath("input"), SystemElementPathTool.buildCssPath("input"),
                SystemElementPathTool.buildTemplatePath("input"), InputElementTemplateLogicConfig.class);
    }
