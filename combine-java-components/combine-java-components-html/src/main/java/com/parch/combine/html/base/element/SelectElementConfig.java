...
@PageElement(key = "select", name = "下拉框元素", templateClass = SelectElementTemplateLogicConfig.class)
public class SelectElementConfig extends ElementConfig<SelectElementTemplateLogicConfig> {
    ...
    public SelectElementConfig() {
        super(SystemElementPathTool.buildJsPath("select"), SystemElementPathTool.buildCssPath("select"),
                SystemElementPathTool.buildTemplatePath("select"), SelectElementTemplateLogicConfig.class);
    }
