...
import com.parch.combine.html.base.template.BannerElementTemplateLogicConfig;
...
@PageElement(key = "banner", name = "横幅元素", templateClass = BannerElementTemplateLogicConfig.class)
public class BannerElementConfig extends ElementConfig<BannerElementTemplateLogicConfig> {
    ...
    public BannerElementConfig() {
        super(SystemElementPathTool.buildJsPath("banner"), SystemElementPathTool.buildCssPath("banner"),
                SystemElementPathTool.buildTemplatePath("banner"), BannerElementTemplateLogicConfig.class);
    }
